...
// @route PUT /api/cart
// @desc Update product quantity in cart for the guest/logged-in user
// @access Public
...
// @route GET /api/cart
// @desc Get the logged-in/guest user's cart
// @access Public
    ...
    if (guestCart) {
      ...
      if (userCart) {
        ...
        guestCart.products.forEach((guestItem) => {
          ...
          if (productIndex > -1) {
            // If the item exists in user's cart, update the quantity
            userCart.products[productIndex].quantity += guestItem.quantity;
          } else {
            // Add guest item to the cart
